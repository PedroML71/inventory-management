...
const CardSalesSummary: FC<CardSalesSummaryProps> = ({}) => {
  ...
  const avarangeChangePercentage =
  ...
  if (isError) {
    return <div className="mr-5">Failed to fetch data</div>;
  }
            ...
            <div className="flex justify-between items-center mb-6 px-7 mt-5">
              <div className="text-lg font-medium">
                ...
                <span className="text-green-500 text-sm ml-2">
                  ...
                  {avarangeChangePercentage.toFixed(2)}%
                </span>
              </div>
              <select
